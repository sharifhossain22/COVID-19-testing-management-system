            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="registered-user-testing.php">Previous registration traking</a>
                    </div>
                </div>
            </li>
 <li class="nav-item">
                <a class="nav-link" href="http://localhost/Covid19-TMS%20Project%20Using%20PHP%20and%20MySQL/covid-tms/login-user.php">
                    <i class="fas fa-fw fa-file"></i>
