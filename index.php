  ...
  <div class="dropdown">
   <a class="dropbtn"style="color:white";>Testing Info</a>
    ...
    <div class="dropdown-content">
      <a href="new-user-testing.php">New Registration</a><br/><br>
      <a href="registered-user-testing.php">PreviousRegistration</a><br/><br>
	  <a href="http://localhost/Covid19-TMS%20Project%20Using%20PHP%20and%20MySQL/covid-tms/login-user.php">Test Report</a><br><br>
   ...
   <a class="dropbtn"style="color:white";>Emergency info</a>
    ...
    <div class="dropdown-content">
	  ...
	  <a href="nbnb.php">protect your self</a>
		  		     ...
		  		     <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="live-test-updates2.php">Upazila wise test</a>
          </li>
		     <li class="nav-item active">
...
<div class="all">
            <div class="buttons">
                ...
                <div class="one">
                    <a href="live-test-updates2.php"><button class="square">Click to view Upazila wise Test </button></a>
                </div>
